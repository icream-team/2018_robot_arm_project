...
namespace PVR
{
    namespace Unity
    {
        public class PVRSession : MonoBehaviour
        {
            ...
            private pvrVector3f[] _hmdToEyeOffset = new pvrVector3f[2];
            private pvrQuatf[] _hmdToEyeRotation = new pvrQuatf[2];
            ...
            public pvrVector3f[] hmdToEyeOffset
            {
                get
                {
                    return _hmdToEyeOffset;
                }
            }

            public pvrQuatf[] hmdToEyeRotation
            {
                get
                {
                    return _hmdToEyeRotation;
                }
            }
            ...
            void UpdateHmdPose()
            {
                if (_ready)
                {
                    ...
                    if (_PoseState.HeadPose.StatusFlags != 0)
                    {
                        for (int i = 0; i < 2; i++)
                        {
                            _clientObject.calcEyePoses(_PoseState.HeadPose.ThePose, _hmdToEyeOffset, _eyePoses);
                        }
                    }
            ...
            private void UpdateRenderInfo()
            {
                for (int i = 0; i < 2; i++)
                {
                    ...
                    _hmdToEyeOffset[i] = _renderInfo[i].HmdToEyeOffset;
                    _hmdToEyeRotation[i] = _renderInfo[i].HmdToEyeRotation;
                }
            }
